...
fn day1_challenge1(s: &str) -> u128 {
    s.trim().to_owned().lines().map(parse_number_1).sum()
}
...
fn test_example() {
    ...
    a1b2c3d4e5f
    treb7uchet";
    assert_eq!(day1_challenge1(input), 142);
}
...
fn test_example_2() {
    ...
    zoneight234
    7pqrstsixteen";
    assert_eq!(day1_challenge2(input), 281);
}
...
fn my_challenge() {
    ...
    3nine6five1";
    assert_eq!(day1_challenge1(input), 53386);
}
...
fn my_challenge2() {
    ...
    fbbdeightzzsdffh8jbjzxkclj
    3nine6five1";
    assert_eq!(day1_challenge2(input), 53312);
}
